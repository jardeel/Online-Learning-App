...
export const FONTS = {
  ...
  // largeTitle: {fontFamily: 'Roboto_100Thin', fontSize: SIZES.largeTitle},
  // h1: {fontFamily: 'Roboto_300Light', fontSize: SIZES.h1, lineHeight: 36},
  // h2: {fontFamily: 'Roboto_400Regular', fontSize: SIZES.h2, lineHeight: 30},
  // h3: {fontFamily: 'Roboto_500Medium', fontSize: SIZES.h3, lineHeight: 22},
  // h4: {fontFamily: 'Roboto_700Bold', fontSize: SIZES.h4, lineHeight: 22},
  // h5: {fontFamily: 'Roboto_900Black', fontSize: SIZES.h5, lineHeight: 22},
  ...
  h2: {fontFamily: 'Roboto_500Medium', fontSize: SIZES.h2, lineHeight: 30},
  h3: {fontFamily: 'Roboto_400Regular', fontSize: SIZES.h3, lineHeight: 22},
  h4: {fontFamily: 'Roboto_300Light', fontSize: SIZES.h4, lineHeight: 22},
  h5: {fontFamily: 'Roboto_100Thin', fontSize: SIZES.h5, lineHeight: 22},
  

  // body1: {fontFamily: 'Roboto_100Thin', fontSize: SIZES.body1, lineHeight: 36},
  // body2: {fontFamily: 'Roboto_300Light', fontSize: SIZES.body2, lineHeight: 30},
  // body3: {fontFamily: 'Roboto_400Regular', fontSize: SIZES.body3, lineHeight: 22},
  // body4: {fontFamily: 'Roboto_500Medium', fontSize: SIZES.body4, lineHeight: 22},
  // body5: {fontFamily: 'Roboto_700Bold', fontSize: SIZES.body5, lineHeight: 22},

  body1: {fontFamily: 'Roboto_700Bold', fontSize: SIZES.body1, lineHeight: 36},
  body2: {fontFamily: 'Roboto_500Medium', fontSize: SIZES.body2, lineHeight: 30},
  body3: {fontFamily: 'Roboto_400Regular', fontSize: SIZES.body3, lineHeight: 22},
  body4: {fontFamily: 'Roboto_300Light', fontSize: SIZES.body4, lineHeight: 22},
